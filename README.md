...
This repository is the executable bootstrap and integration reference for the Dossiya-SE Mathematics Research Ecosystem.

It is organized as a monorepo prototype with twelve bounded modules. Each module has a distinct research responsibility and an internal contract designed to remain stable if the module is later separated into its own repository.
